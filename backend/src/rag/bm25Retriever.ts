...
export class BM25Retriever {
  private documents: SchemeDocument[] = [];
  private k1: number;
  private b: number;
  ...
  constructor(documents: SchemeDocument[], k1 = 1.5, b = 0.75) {
  ...
  public search(query: string, limit = 30): { doc: SchemeDocument; score: number }[] {
