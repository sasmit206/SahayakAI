...
async function getRecommendations(profile, userQuery, limit = 5) {
    ...
    const hybridResults = await (0, hybridRetriever_1.retrieveHybrid)(query, 50);
    ...
    const top5Schemes = await (0, reranker_1.rerankCandidates)(query, top30Candidates, limit);
    // 4. FORMAT OUTPUT
