...
exports.applyDirectFieldValue = applyDirectFieldValue;
...
function applyDirectFieldValue(field, value, currentProfile) {
    ...
    switch (field) {
        case 'gender':
            ...
            break;
        case 'maritalStatus':
            if (['Single', 'Married', 'Widowed', 'Divorced'].includes(value))
                profile.maritalStatus = value;
            break;
        case 'category':
